...
function gKDR_GMM_freerun_det(UGE_TASK_ID_text)
% UGE_TASK_ID_text
...
for Ki = 1:length(Ks)
    ...
    for kGMM = kGMMs
        ...
        simulation_result_subfolder = fullfile(simulation_results_folder, [link '_det' '_k' num2str(embed_width) '_tau' num2str(embed_step) '_K' num2str(K) '_kGMM' num2str(kGMM)]);
